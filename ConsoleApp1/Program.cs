    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (ValikMenu == 1)
            {
                    ...
                    Typewrite("Dimitri: Aga sellepeale me ju võtame ?\nPeeter: Muidugi võtame.\nTanja: Kutid võtke nüüd rahulikult\nKutid: võtame võtame..");
                    Console.WriteLine("Tanja: Artjom sa suitsu ei taha muidu?\n[Tahan/Ei taha]");
                    ...
                    {
                        Typewrite("Vaatamata Artjomi soovidest, surutakse talle ikka suits peale ning ta hakkb seda tõmmates köhima.");
                    }
                    else
                    {
                        Console.WriteLine("Sellist valikut ei ole, proovi uuesti.");
